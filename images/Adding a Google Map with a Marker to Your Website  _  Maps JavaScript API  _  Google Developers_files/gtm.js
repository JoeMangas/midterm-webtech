...
"resource": {
  ...
  "rules":[
    ...
    [["if",1,2],["add",0]],
    [["if",1],["add",1,181,182,183,184,185,186,187,188,189,190,191,192,193,194]],
    [["if",6],["add",2,19]],
    [["if",7],["add",3,20]],
    [["if",6,8],["add",4]],
    [["if",9],["add",5,25]],
    [["if",11],["add",6,17]],
    [["if",11,15],["add",7,9,10,11,12,13,14,21,29,53,65,66,159,160]],
    [["if",11,16],["add",8,52]],
    ...
    [["if",1,30],["add",36]],
    [["if",1,31],["add",37]],
    [["if",11,32,33,34,35,36],["add",39]],
    [["if",11,32,34,35,37,38],["add",40]],
    [["if",11,32,34,35,36,39],["add",41]],
    [["if",11,32,34,35,36,40],["add",42]],
    [["if",11,32,34,35,41,42],["add",43]],
    [["if",11,43],["add",44,48]],
    [["if",11,44,45],["add",45]],
    [["if",11,32,34,35,36,46],["add",46]],
    [["if",1,47],["add",47]],
    [["if",1,48,49,50,51],["add",49]],
    [["if",1,48,49,51,52],["add",50]],
    [["if",1,53],["add",51]],
    [["if",1,54],["add",54]],
    ...
    [["if",84,85,86],["add",86]],
    [["if",1,87],["add",87]],
    [["if",0,11],["unless",10,14],["add",88],["block",6]],
    [["if",0,9],["unless",10],["add",89],["block",5]],
    [["if",11,88,89],["add",90]],
    [["if",11,90,91],["add",91]],
    [["if",11,92],["add",93]],
    [["if",0,93,94],["add",94]],
    ...
    [["if",1,114],["add",103,104,112]],
    [["if",64,110,115,116],["add",105]],
    [["if",64,110,117,118],["add",106]],
    [["if",1,119],["add",107,108,121]],
    [["if",113,120,121],["add",109]],
    [["if",64,120,122,123],["add",110]],
    [["if",64,120,124,125],["add",111]],
    [["if",1,108],["add",113]],
    [["if",1,114,126],["add",114,115,116,117,118,119,164]],
    [["if",9,71,127],["add",120]],
    [["if",94,96],["add",121,173],["block",94]],
    [["if",9,72,127],["add",122]],
    [["if",128,129],["add",123]],
    [["if",128,130],["add",124]],
    [["if",2,64,131,132],["add",125]],
    [["if",0,64,134],["unless",133],["add",126]],
    [["if",93,94,95],["add",127],["block",94]],
    [["if",6,135],["add",128,129,130,131,132,133,163]],
    [["if",11,55,56,136],["add",134,135,136,137,139]],
    [["if",1,137],["add",138],["block",164]],
    [["if",94],["add",140,169]],
    [["if",11,139,140,141],["add",141,145,166]],
    [["if",11,139,141,142],["add",142,158]],
    [["if",11,139,141,143],["add",143,146,147,148,149,150,151,152,167,168]],
    [["if",11,139,141,144],["add",144,153]],
    [["if",11,139,141,145],["add",154]],
    [["if",0,1,97],["add",155]],
    [["if",113,146],["add",156]],
    [["if",0,11,147,148,149],["add",157]],
    [["if",0,11,90,149],["add",157]],
    [["if",11,150,151,152],["add",159]],
    [["if",11,150],["add",161]],
    [["if",6,153],["add",162]],
    [["if",4,96],["add",165]],
    [["if",155],["add",169]],
    [["if",1,156,157],["add",170]],
    [["if",1,158],["add",171,172]],
    [["if",1,159,160],["add",174,179,180]],
    [["if",1,159,161],["add",175,177,178]],
    [["if",1,159],["add",176]],
    [["if",3,4],["block",0,1,2,3,5,6,17,18,19,20,25,26,88,89,95,96,98,101,102,103,106,107,109,111,123,124,125,126]],
    [["if",1,5],["block",0]],
    [["if",11,12,13],["block",6,88,102,109]],
    [["if",4,20],["block",17,18,19,20,25]],
    [["if",4],["block",27,28,31,49,50,51,63]],
    [["if",0,94,97],["block",94]],
    [["if",4,138],["block",140,158,159,160,161,162,163,166,169]],
    [["if",4,154],["block",165]]]
},
"runtime":[
[],[]
...
b.vtp_trackType){}else if("TRACK_TRANSACTION"==b.vtp_trackType){}else if("TRACK_TIMING"==b.vtp_trackType){}else if("DECORATE_LINK"==b.vtp_trackType){var ka=U("gtm.element",1);ka&&n(function(){var a=Ue(),c=a&&a.getByName&&a.getByName(r),
d=tj(X("gaplugins").Linker,c);ka&&ka.href&&(ka.href=d.decorate(ka.href,b.vtp_useHashDecorateLink),B(b.vtp_gtmOnSuccess))});}else if("DECORATE_FORM"==b.vtp_trackType){}else if("TRACK_DATA"==
...
Z.a.ga=["google"],function(){var a,b,c=function(c){function d(a){var b=[].slice.call(arguments,0);b[0]=w+b[0];t.push(b)}function g(a,b){void 0!==c[b]&&d(a,c[b])}function h(a,b){void 0!==c[b]&&d(a,Number(c[b]))}function k(a,b){if(r(b))for(var c=0;c<b.length;c++)d(a,b[c])}function l(a,b,c){if(r(b))for(var e=0;e<b.length;e++){for(var g=[a],h=b[e],k=0;k<c.length;k++)g.push(h[c[k]]);d.apply(this,g)}}function m(a,b){void 0!==c[b]&&d("_set",a,c[b])}function n(a,b){return void 0===b?b:a(b)}function q(a,b){void 0!==
b&&(C+="&"+a+"="+b)}var r=wa,t=X("_gaq",[],!1),v=!1,w="";void 0==c.vtp_trackerName?w="gtm"+fe()+".":""!==c.vtp_trackerName&&(w=c.vtp_trackerName+".");g("_setAccount","vtp_webPropertyId");d("_set","gtmid",yi(!0));
...
C){var F=function(a,b,c){for(var d=b.length-1;0<=d;d--){var e=b[d].split("=");if(e[0]===a)return e[1]||"1"}for(var g=c.length-1;0<=g;g--){var h=c[g].split("=");if(h[0]===a)return h[1]||"1"}},D=H(bj()),J=G(D,"query").split("&"),W=c.vtp_allowAnchor?G(D,"fragment").split("&"):[];q("gclid",F("gclid",W,J));q("gclsrc",F("gclsrc",W,J));q("dclid",F("dclid",W,J));d("_set","campaignParams",C)}m("anonymizeIp","vtp_anonymizeIp");
...
void 0!==c.vtp_forceSsl&&c.vtp_forceSsl&&(t.push(["_gat._forceSSL"]),v=!!c.vtp_forceSsl);d("_set","hitCallback",function(){ua(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==c.vtp_trackType){}else if("TRACK_SOCIAL"==c.vtp_trackType){}else if("TRACK_TIMING"==
c.vtp_trackType){}else if("DECORATE_LINK"==c.vtp_trackType){var P=U("gtm.element",1);P&&t.push(function(){var a=X("_gat"),b=a._getTrackerByName(w.slice(0,
-1)),d=P.href;if(d){var e=/(.*)([?&#])(?:__utma=.*__utmk=[^&]*)(?:&?)(.*)/.exec(d);e&&3<=e.length&&(d=e[1]+(e[3]?e[2]+e[3]:""));P.href=b._getLinkerUrl(d,c.vtp_useHashDecorateLink);B(c.vtp_gtmOnSuccess)}});}else if("DECORATE_FORM"==c.vtp_trackType){}else d("_trackPageview");k("_cookiePathCopy",c.vtp_cookiePathCopy);
var O=function(){X("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,S(M("https","http","://stats.g.doubleclick.net/dc.js",v),O,c.vtp_gtmOnFailure));else if(!a){var V=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;S(M("https://ssl","http://www",V,v),O,c.vtp_gtmOnFailure)}};Z.__ga=c;Z.__ga.g="ga";Z.__ga.h=!0;Z.__ga.b=0}();
...
Z.a.gcs=["google"],function(){(function(a){Z.__gcs=a;Z.__gcs.g="gcs";Z.__gcs.h=!0;Z.__gcs.b=0})(function(a){try{var b=a.vtp_siteId;if(!X("_gtmgcs")){z._gtmgcs={};var c=M("https:","http:","//survey.g.doubleclick.net/async_survey?site="+Y(b));S(c)}a.vtp_gtmOnSuccess()}catch(d){B(a.vtp_gtmOnFailure)}})}();

Z.a.remm=["google"],function(){(function(a){Z.__remm=a;Z.__remm.g="remm";Z.__remm.h=!0;Z.__remm.b=0})(function(a){for(var b=a.vtp_input,c=a.vtp_map||[],d=a.vtp_fullMatch,e=a.vtp_ignoreCase?"gi":"g",g=0;g<c.length;g++){var h=c[g].key||"";d&&(h="^"+h+"$");var k=new RegExp(h,e);if(k.test(b)){var l=c[g].value;a.vtp_replaceAfterMatch&&(l=String(b).replace(k,l));return l}}return a.vtp_defaultValue})}();Z.a.smm=["google"],function(){(function(a){Z.__smm=a;Z.__smm.g="smm";Z.__smm.h=!0;Z.__smm.b=0})(function(a){var b=a.vtp_input,c=xj(a.vtp_map,"key","value")||{};return c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue})}();
